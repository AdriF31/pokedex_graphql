  ...
  Widget build(BuildContext context) {
    return GetBuilder<DetailController>(
        ...
        builder: (controller) => Scaffold(
            backgroundColor:
                controller.pokemonDetail!.data!.details!.first.types!.isNotEmpty
                    ? controller.pokemonDetail?.data?.details?.first.types
                        ?.first.type?.name
                        ?.toPokemonTypeColor()
                    : Colors.white,
            appBar: AppBar(
            ...
            body: controller.pokemonDetail != null
                ? Stack(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: controller.pokemonDetail!.data!
                                        .details!.first.types!.isNotEmpty
